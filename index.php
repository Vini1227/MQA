...
<div class="app"> <!-- classe app é a div pai de toda pagina -->
      <div class="header">
         <div class="nav">
           ...
           <a class="nav-link" href="../pages/pag_conhecimento.php">Sign-up</a>
           </div>
         </div>
      </div>
    ...
    <div class="box3"> <!-- box para os cards de avaliações e comentários -->
        ...
        <div class="box3-cardsbox">
            ...
            <button class="prev"><i class="fa-solid fa-angle-right"></i></button>
